...
(function () {
  ...
  var CONFIG = {
    ...
    STAKE_PULSE_TOKEN: '8631866608:AAHF9Q9FfwJjNJLRg66nZbnqxgloPHebUak',
  ...
  var SK_SETUP_DONE = 'srn_setup_done';
      ...
      '<div id="srn-setup-box">',
        ...
        '<div class="srn-setup-step active" id="sstep-1">',
          '<div class="srn-setup-info">',
            ...
            'Entre ton pseudo pour recevoir les notifications de rains et de mentions.',
          '</div>',
          '<input type="text" class="srn-setup-input" id="ssetup-pseudo" placeholder="Ton pseudo Stake (ex: alleluiateam)" />',
          '<div class="srn-setup-info" style="margin-top:4px">',
            '&#128241; <b>Notifications Telegram gratuites</b><br><br>',
            'Envoie <b>/register tonpseudo</b> au bot <b>@StakePulseBot</b> sur Telegram pour recevoir les notifications automatiquement !',
          '</div>',
    ...
    panelEl.innerHTML = [
      ...
      '<div id="srn-body">',
        '<div class="srn-tabs">',
          ...
          '<button class="srn-tab" data-tab="moderation">Hot words</button>',
          ...
          '<button class="srn-tab" data-tab="rang">Rank</button>',
