...
// @run-at       document-start      // Démarre avant le chargement de la page pour intercepter le WebSocket
...
(function () {
  ...
  var CURRENT_VERSION = "5.4.2"; // Doit correspondre à @version dans l'en-tête
