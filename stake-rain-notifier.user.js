...
'.srn-tick-down{color:#ff4444}',
    ...
    panelEl.innerHTML = [
      ...
      '<div id="srn-body">',
        ...
        '<div class="srn-sec" id="tab-settings">',
          ...
          '<button class="srn-btn" style="margin-top:5px" data-srn="replaySetup">&#9654; Revoir le setup</button>',
        '</div>',
      '</div>',
  ...
  function showUpdateBanner(newVersion) {
    ...
    banner.innerHTML = '<div style="display:flex;align-items:center;gap:6px">'
      ...
      + '<button id="srn-update-btn" style="background:#00ff8822;border:1px solid #00ff8855;border-radius:6px;color:#00ff88;cursor:pointer;font-size:11px;font-weight:700;padding:4px 10px">Installer</button>';
