...
// @version      1.4.2
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.4.2 - Filtrage par chat
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  function renderTabsToggles() {
    ...
    el.innerHTML = tabs.map(function(t) {
      ...
      return '<div data-tabid="' + t.id + '" style="display:flex;align-items:center;justify-content:space-between;background:#162330;border:1px solid ' + (on ? '#00d4ff44' : '#1e3a4a') + ';border-radius:8px;padding:7px 10px;font-size:12px;color:' + txtColor + ';font-weight:' + (on ? '600' : '400') + ';transition:opacity .15s">'
        + '<div style="display:flex;align-items:center;flex:1"><span class="srn-tab-label">' + t.label + '</span></div>'
  ...
  var CURRENT_VERSION = '1.4.2'; // Doit correspondre a @version
