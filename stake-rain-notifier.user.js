    ...
    panelEl.innerHTML = [
      ...
      '<div id="srn-body">',
        '<div class="srn-tabs">',
          ...
          '<button class="srn-tab" data-tab="rainers">(WIP) Rains</button>',
          '<button class="srn-tab" data-tab="wager">(WIP) Stats Wager</button>',
          '<button class="srn-tab" data-tab="multip">(WIP) Multiplicateur</button>',
