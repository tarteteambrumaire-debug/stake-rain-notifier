...
// @version      1.4.8
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.4.8 - Temps réel tous chats
// @author       alleluiateam
        ...
        if (data[key] !== undefined && data[key] !== null) {
          ...
          if (Array.isArray(data[key]) && Array.isArray(local)) {
            ...
            data[key].forEach(function(e) {
              // Si chat préféré défini : n'importer QUE les entrées avec le bon chatId
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.4.8'; // Doit correspondre a @version
