...
// @version      5.2.3
// @description  Rain & Stats tracker pour Stake.bet - by alleluiateam
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  function buildPanel() {
    ...
    panelEl.innerHTML = [
      '<div id="srn-hdr">',
        '<span>&#127783; Rain Notifier <span style="font-size:9px;color:#1e3a4a;margin-left:4px">by alleluiateam</span> <span id="srn-notif-badge" style="display:none;background:#ff4444;color:#fff;border-radius:999px;font-size:10px;padding:1px 6px;margin-left:4px;font-weight:700;vertical-align:middle"></span></span>',
      ...
      '<div id="srn-body">',
        ...
        '<div class="srn-sec" id="tab-rainers">',
          '<div style="position:relative">',
            '<div style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:999;background:rgba(15,25,35,0.92);border-radius:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:20px;min-height:150px">',
              '<div style="font-size:40px;margin-bottom:10px">&#9888;</div>',
              '<div style="color:#ffd700;font-size:16px;font-weight:800;margin-bottom:8px">Work In Progress</div>',
              '<div style="color:#8899aa;font-size:12px;line-height:1.6">Cette section est en cours de developpement.<br>Les donnees peuvent ne pas etre fiables.</div>',
            '</div>',
          '</div>',
