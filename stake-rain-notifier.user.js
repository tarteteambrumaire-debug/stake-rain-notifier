...
// @version      1.4.13
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.4.13 - Anti-doublons
// @author       alleluiateam
        ...
        if (data[key] !== undefined && data[key] !== null) {
          ...
          if (Array.isArray(data[key]) && Array.isArray(local)) {
            ...
            data[key].forEach(function(e) {
              ...
              if (localKeys.indexOf(k) < 0) { merged.push(e); localKeys.push(k); }
            });
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.4.13'; // Doit correspondre a @version
