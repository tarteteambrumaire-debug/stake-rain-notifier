// ==UserScript==
// @name         StakePulse (Chrome)
// @namespace    https://stake.bet/stakepulse
// @version      1.1.4-chrome
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.1.4-chrome'; // Doit correspondre a @version
  ...
  function init() {
    ...
    // Chrome-compatible init: attend le body via MutationObserver
